...
spa.proc = (function () {
  ...
  setJqueryMap = function () {
    ...
    $proc        = $append_target.find( '.spa-proc' );
  ...
  //     of slider animation.  The callback proceives a jQuery
  ...
  setPosition = function ( position_type, callback ) {
    ...
    switch ( position_type ){
      case 'opened' :
      jqueryMap.$proc.css({ display : 'block'});
      break;

      case 'closed' :
      jqueryMap.$proc.css({ display : 'none'})
      break;

      // bail for unknown position_type
      default : jqueryMap.$proc.css({ display : 'none'});
    }
    return true;
  };
  ...
  initModule = function ( $append_target ) {
    ...
    $append_target.append( configMap.proc_html );
    setJqueryMap();
    return true;
  };
