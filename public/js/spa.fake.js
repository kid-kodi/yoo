...
spa.fake = (function () {
  ...
  peopleList = [
    { avtr : 'img/assana.jpg', time : '*', name : 'Betty', _id : 'id_01',
      css_map : { top: 20, left: 20,
        'background-color' : 'rgb( 128, 128, 128)'
      }
    },
    { avtr : 'img/yan.jpg', time : '*', name : 'Mike', _id : 'id_02',
      css_map : { top: 60, left: 20,
        'background-color' : 'rgb( 128, 255, 128)'
      }
    },
    { avtr : 'img/innocent.jpg', time : '5s', name : 'Pebbles', _id : 'id_03',
      css_map : { top: 100, left: 20,
        'background-color' : 'rgb( 128, 192, 192)'
      }
    },
    { avtr : 'img/lionel.jpg', time : '11s', name : 'Wilma', _id : 'id_04',
