...
spa.home = (function () {
  ...
  setJqueryMap = function () {
    ...
    $home        = $append_target.find( '.spa-home' );
  ...
  setPosition = function ( position_type, callback ) {
    ...
    switch ( position_type ){
      case 'opened' :
      jqueryMap.$home.css({ display : 'block'});
      break;

      case 'closed' :
      jqueryMap.$home.css({ display : 'none'})
      break;

      // bail for unknown position_type
      default : jqueryMap.$home.css({ display : 'none'});
    }
    return true;
  };
  ...
  initModule = function ( $append_target ) {
    ...
    $append_target.append( configMap.home_html );
    setJqueryMap();
    return true;
  };
