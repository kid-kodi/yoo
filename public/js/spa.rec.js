...
spa.rec = (function () {
  ...
  setJqueryMap = function () {
    ...
    $rec        = $append_target.find( '.spa-rec' );
  ...
  setPosition = function ( position_type, callback ) {
    ...
    switch ( position_type ){
      case 'opened' :
      jqueryMap.$rec.css({ display : 'block'});
      break;

      case 'closed' :
      jqueryMap.$rec.css({ display : 'none'})
      break;

      // bail for unknown position_type
      default : jqueryMap.$rec.css({ display : 'none'});
    }
    return true;
  };
  ...
  initModule = function ( $append_target ) {
    ...
    $append_target.append( configMap.rec_html );
    setJqueryMap();
    return true;
  };
