...
spa.admin = (function () {
  ...
  setJqueryMap = function () {
    ...
    $admin        = $append_target.find( '.spa-admin' );
  ...
  //     of slider animation.  The callback admineives a jQuery
  ...
  setPosition = function ( position_type, callback ) {
    ...
    switch ( position_type ){
      case 'opened' :
      jqueryMap.$admin.css({ display : 'block'});
      break;

      case 'closed' :
      jqueryMap.$admin.css({ display : 'none'})
      break;

      // bail for unknown position_type
      default : jqueryMap.$admin.css({ display : 'none'});
    }
    return true;
  };
  ...
  initModule = function ( $append_target ) {
    ...
    $append_target.append( configMap.admin_html );
    setJqueryMap();
    return true;
  };
