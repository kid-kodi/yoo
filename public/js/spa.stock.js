...
spa.stock = (function () {
  ...
  setJqueryMap = function () {
    ...
    $stock        = $append_target.find( '.spa-stock' );
  ...
  //     of slider animation.  The callback stockeives a jQuery
  ...
  setPosition = function ( position_type, callback ) {
    ...
    switch ( position_type ){
      case 'opened' :
      jqueryMap.$stock.css({ display : 'block'});
      break;

      case 'closed' :
      jqueryMap.$stock.css({ display : 'none'})
      break;

      // bail for unknown position_type
      default : jqueryMap.$stock.css({ display : 'none'});
    }
    return true;
  };
  ...
  initModule = function ( $append_target ) {
    ...
    $append_target.append( configMap.stock_html );
    setJqueryMap();
    return true;
  };
