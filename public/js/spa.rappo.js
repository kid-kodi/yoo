...
spa.rappo = (function () {
  ...
  setJqueryMap = function () {
    ...
    $rappo        = $append_target.find( '.spa-rappo' );
  ...
  //     of slider animation.  The callback rappoeives a jQuery
  ...
  setPosition = function ( position_type, callback ) {
    ...
    switch ( position_type ){
      case 'opened' :
      jqueryMap.$rappo.css({ display : 'block'});
      break;

      case 'closed' :
      jqueryMap.$rappo.css({ display : 'none'})
      break;

      // bail for unknown position_type
      default : jqueryMap.$rappo.css({ display : 'none'});
    }
    return true;
  };
  ...
  initModule = function ( $append_target ) {
    ...
    $append_target.append( configMap.rappo_html );
    setJqueryMap();
    return true;
  };
