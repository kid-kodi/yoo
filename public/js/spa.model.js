...
spa.model = (function () {
  ...
  makePerson = function ( person_map ) {
    var person,
      ...
      id          = person_map.id,
      avtr        = person_map.avtr,
      name        = person_map.name,
      time        = person_map.time,
  ...
  people = (function () {
    ...
    login = function ( name ) {
      ...
      sio.emit( 'adduser', {
        ...
        avtr        : stateMap.user.avtr,
        name        : stateMap.user.name,
        time        : stateMap.user.time,
